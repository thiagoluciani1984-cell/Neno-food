...
/** Porta 1:1 de src/features/orders/print-receipt.ts pra rodar em Node puro. */
function buildOrderReceipt(order, restaurantName) {
...
module.exports = { buildOrderReceipt };
